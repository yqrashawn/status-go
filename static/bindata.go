...
func ConfigCliFleetEthStagingJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.staging.json", size: 1980, mode: os.FileMode(0644), modTime: time.Unix(1645612837, 0)}
...
func ConfigCliFleetStatusTestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-status.test.json", size: 937, mode: os.FileMode(0644), modTime: time.Unix(1645612833, 0)}
