...
echo "building status-go static lib..."
go build %BUILD_FLAGS% -buildmode=c-archive -o %GOBIN%\build\bin\libstatus.lib %GOBIN%\build\bin\statusgo-lib
echo "status-go static lib built..."